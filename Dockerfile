...
COPY version .
RUN zypper install -y python python3-Flask python3-Flask-Admin python3-pyaml python3-Werkzeug python3-Flask-HTTPAuth python3-pycryptodomex python3-pip python311-pipx system-user-nobody python3-Flask-RESTful python3-Flask-Login python3-Flask-Testing 
RUN pip install --break-system-packages Flask-BasicAuth iputils
